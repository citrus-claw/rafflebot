...
export function BuyTicketsModal({ raffle, onClose }: BuyTicketsModalProps) {
  ...
  if (purchased) {
    return (
      <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
        <div className="max-w-sm w-full bg-carnival-red p-1 rounded-xl shadow-chunky">
          <div className="bg-surface border-2 border-dashed border-ink p-8 rounded-lg text-center">
            ...
            <div className="bg-paper border-2 border-ink p-4 rounded-lg mb-6 text-left">
            ...
            <button
              onClick={onClose}
              className="w-full bg-carnival-blue text-white py-3 rounded-lg font-display text-sm uppercase tracking-widest hover:bg-ink transition-all shadow-[0px_4px_0px_0px_#003352]"
            >
              Done
            </button>
          </div>
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-carnival-red p-1 rounded-xl shadow-chunky max-w-md w-full">
        <div className="bg-surface border-2 border-dashed border-ink p-6 rounded-lg">
          ...
          <div className="space-y-6">
            ...
            <button
              onClick={handleBuy}
              disabled={loading}
              className="w-full bg-carnival-blue text-white py-4 rounded-lg font-display text-xl uppercase tracking-widest hover:bg-ink transition-all transform hover:-translate-y-1 active:translate-y-0 shadow-[0px_4px_0px_0px_#003352] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
